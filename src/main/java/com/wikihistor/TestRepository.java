    ...
    public class TestRepository implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
            this.userService.saveUser(new Wikiuser("log1","pas1"));
            this.userService.saveUser(new Wikiuser("log2", "pas2"));
            this.userService.saveUser(new Wikiuser("admin", "admin"));
            this.categoryService.saveArticle(new Article("default", "default"), "default");
